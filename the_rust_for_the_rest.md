...
実はC/Cppの代替を目指すと言うコンセプトはRust以前からあります
GCなんかはまさしくこれが原動力になっていると思うのですが、メモリ管理の煩雑さから解放される代わりにパフォーマンスが犠牲になっていました
...
なんなら、Solanaやポルカドットといった有名プラットフォームはRustで実装されています
...
ただメインストリームでは無いにしろ、AI開発にRustを使いたいという需要は根強いです
